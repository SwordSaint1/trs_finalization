        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-close">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="sched_refresh_final.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Refresh Final</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="sched_refresh_initial.php" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Refresh Initial</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="sched_sb_final_all.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>SB-Final All Process</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="cancelled_request.php" class="nav-link">
