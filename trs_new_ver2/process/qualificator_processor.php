 ...
 if ($method == 'cancel_qualif_pending') {
    ...
    foreach($id as $x){
        ...
        if ($stmt->execute()) {
             ...
             $que = "INSERT INTO trs_qualif (batch_num, employee_num, qsection,qualif_remarks, training_need, qualif_cancel_date, ptt, eq, pe, pd, qa)
                SELECT batch_number, employee_num, esection, remarks, training_need, qualifcancel_date, ptt, eq, pe, pd, qa FROM trs_request WHERE approval_status = 0 AND id ='$x'";
